...
public static partial class WishlistsEndpoints
{
    private static async
        Task<Results<Created<AddWishResponse>, NotFound<Error>, ForbidHttpResult, UnauthorizedHttpResult>> AddWish(
            [FromRoute] Guid id,
            AddWishRequest request,
            ClaimsPrincipal user,
            ApplicationDbContext db,
            IAuthorizationService authorizationService,
            ICommandHandler<AddWishCommand, AddWishResponse> handler,
