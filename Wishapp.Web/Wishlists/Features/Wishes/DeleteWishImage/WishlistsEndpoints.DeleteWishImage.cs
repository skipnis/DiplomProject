...
using Wishapp.Web.Wishlists.Features.Wishes.DeleteWishImage;

namespace Wishapp.Web.Wishlists;

public static partial class WishlistsEndpoints
{
    private static async Task<Results<NoContent, NotFound<Error>, ForbidHttpResult, UnauthorizedHttpResult>> DeleteWishImage(
        [FromRoute] Guid id,
        [FromRoute] Guid wishId,
        ClaimsPrincipal user,
        ApplicationDbContext db,
        IAuthorizationService authorizationService,
        ICommandHandler<DeleteWishImageCommand> handler,
