...
{
    private static async Task<Results<NoContent, NotFound<Error>, ForbidHttpResult, UnauthorizedHttpResult>> UnfulfillWish(
        [FromRoute] Guid id,
        [FromRoute] Guid wishId,
        ClaimsPrincipal user,
        ApplicationDbContext db,
        IAuthorizationService authorizationService,
        ICommandHandler<Features.Wishes.UnfulfillWish.UnfulfillWishCommand> handler,
        CancellationToken ct)
    {
        ...
        var result = await handler.HandleAsync(new Features.Wishes.UnfulfillWish.UnfulfillWishCommand(id, wishId), ct);
