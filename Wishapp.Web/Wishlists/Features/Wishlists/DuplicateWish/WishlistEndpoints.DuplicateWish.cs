...
using Wishapp.Web.Wishlists.Features.Wishlists.DuplicateWish;
...
public static partial class WishlistsEndpoints
{
    private static async
        Task<Results<Created<DuplicateWishResponse>, NotFound<Error>, ForbidHttpResult, UnauthorizedHttpResult>>
        DuplicateWish(
            [FromRoute] Guid id,
            ...
            ICommandHandler<DuplicateWishCommand, DuplicateWishResponse> handler,
            CancellationToken ct)
    {
        ...
        return TypedResults.Created($"/wishlists/{id}/wishes/{result.Value.WishId}", result.Value);
    }
}
