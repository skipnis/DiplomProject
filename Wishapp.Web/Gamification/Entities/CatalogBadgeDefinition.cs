...
public sealed class CatalogBadgeDefinition
{
    ...
    public static CatalogBadgeDefinition Create(string emoji, string slug, string label, string description)
    {
        return new CatalogBadgeDefinition { Emoji = emoji, Slug = slug, Label = label, Description = description, IsActive = true };
    }
